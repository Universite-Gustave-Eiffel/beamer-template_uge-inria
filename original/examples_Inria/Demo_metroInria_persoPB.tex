...
%==============================================================================
	...
	\makeatletter
		\def\input@path{{\PathSO}{\PathSO/UGE/}{\PathSO/Inria/}} 		% to be able to find package in resource folders.
...
%-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
	...
	%	\colorlet{ColorProgBar}{red!82!green!42!blue!100} % or {UGEa} % from MetropolisBeamerExtra
...
%-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
	...
	\logo{\includegraphics[width=2.5cm]{\PathSO/UGE/logos/UGE-logo.pdf}}
	\addtobeamertemplate{logo}{\vspace{0.85\paperheight}}{} % Top Right
...
\input{\PathP/Section-Metropolis.tex}

\input{\PathP/Section-UGE.tex}
