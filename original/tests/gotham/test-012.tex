...
\makeatletter
	\def\input@path{{\PathSO}{\PathSO/Inria/}{\PathSO/UGE/}} 		% to be able to find package in resource folders.
...
\date[shortdate]{\today}
\author[john.doe@mail.com]{John DOE\inst{1,2,3} John DOE\inst{1,2,3} John DOE\inst{1,2,3}}
